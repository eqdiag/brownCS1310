...
#define MARKER 0xBEAFF00D

struct alloc_header{
    unsigned long long size; //Size of allocated memory in bytes
    bool free;
    size_t mem_start;
    int header_marker;
};
...
//Additional free needed in case alloc_header metadata free is overwritten by malicious user

extern struct dmalloc_stats g_stats;
extern std::unordered_map<void*,alloc_record> g_freed_set;
